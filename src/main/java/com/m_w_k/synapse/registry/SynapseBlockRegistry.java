...
public final class SynapseBlockRegistry {
    ...
    public static final RegistryObject<DistributorBlock> DISTRIBUTOR_BLOCK_1 = BLOCKS.register("distributor_block_1",
            () -> new DistributorBlock(BlockBehaviour.Properties.of().lightLevel(state -> 2).mapColor(MapColor.COLOR_LIGHT_BLUE).requiresCorrectToolForDrops().strength(1.5f, 6), ConnectorLevel.DISTRIBUTOR_1));
    public static final RegistryObject<DistributorBlock> DISTRIBUTOR_BLOCK_2 = BLOCKS.register("distributor_block_2",
            () -> new DistributorBlock(BlockBehaviour.Properties.of().lightLevel(state -> 2).mapColor(MapColor.COLOR_ORANGE).requiresCorrectToolForDrops().strength(1.5f, 6), ConnectorLevel.DISTRIBUTOR_2));
    public static final RegistryObject<DistributorBlock> DISTRIBUTOR_BLOCK_3 = BLOCKS.register("distributor_block_3",
            () -> new DistributorBlock(BlockBehaviour.Properties.of().lightLevel(state -> 2).mapColor(MapColor.COLOR_BLUE).requiresCorrectToolForDrops().strength(1.5f, 6), ConnectorLevel.DISTRIBUTOR_3));
...
//            () -> new DASBlock(BlockBehaviour.Properties.of()));
    ...
    public static final RegistryObject<EndpointBlock> ENDPOINT_BASIC = BLOCKS.register("endpoint_basic",
            () -> new EndpointBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(1f, 4)));
    public static final RegistryObject<RelayBlock> RELAY = BLOCKS.register("relay",
            () -> new RelayBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_LIGHT_GRAY).requiresCorrectToolForDrops().strength(1f, 3)));
